...
if(isset($_POST['btnHome'])){
    ...
    $query=mysqli_query($con,"update home_setting set slogan='$slogan', slogantext='$SloganText', desc1='$desc1',  desc2='$desc2',  desc3='$desc3', desc4='$desc4',desc5='$desc5' where Id='0'");
