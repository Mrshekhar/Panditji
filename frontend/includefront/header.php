								...
								<ul class="lab-ul d-flex flex-wrap justify-content-end">
									<li class="d-flex flex-wrap align-items-center">
										...
										<div class="ht-add-content">
											<span>NH-100 Road</span>
											<span class="d-block text-bold">Jhumra, Jinga Hazaribagh</span>
										</div>
									</li>
									<li class="d-flex flex-wrap align-items-center">
										<div class="ht-add-thumb mr-2">
										...
										<div class="ht-add-content">
											<span>Send Mail </span>
											<span class="d-block text-bold">ismartshankar809@gmail.com</span>
										</div>
									</li>
									<li class="d-flex flex-wrap align-items-center">
										<div class="ht-add-thumb mr-2">
										...
										<div class="ht-add-content">
											<span>Make Call </span>
											<span class="d-block text-bold">8252553686</span>
										</div>
									</li>
							...
							<div class="main-area w-100">
								<div class="main-menu d-flex flex-wrap align-items-center justify-content-between w-100">
									...
									<ul class="lab-ul">
										...
										<li><a href="Panditjii.php"> Pandit Ji</a></li>
										<!-- <li>
								<a href="#">Pandit jii</a>
								<ul class="lab-ul">
									<li><a href="view_Pandit.php">Recommended Pandit</a></li>
